...
router.get('/', async (req, res) => {
    ...
    try {
        ...
        groupedPrescriptions.beforeToday.sort((a, b) => a.value - b.value); // Different sort order
        groupedPrescriptions.afterToday.sort((a, b) => a.value - b.value); // Different sort order
